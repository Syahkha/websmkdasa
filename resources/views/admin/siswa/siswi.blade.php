    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">Data Siswi</div>
            </div>
            <div class="card-body">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">                                              
                                        <h4 class="modal-title">Update Siswi</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{url('update-siswi')}}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="">
                    ...
                    @foreach($siswi as $item)
                        <div class="modal fade" id="dtl{{$item->id}}">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">                                              
                                        <h4 class="modal-title">Detail Siswi</h4>
                                    </div>
                                    <div class="modal-body">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" name="ids" value="{{$item->ids}}">
                                        <input type="hidden" name="idortu" value="{{$item->idortu}}">
                                        <p>Apakah anda ingin menghapus data siswi <br>Dengan Nama :<br><b>{{$item->nama_lengkap}}</b></p>
                                    </div>
                                    <div class="modal-footer">
                                        <a href="{{url('hapus-siswi').'/'.$item->ids.'/'.$item->idortu}}" class="btn btn-outline-danger"><i class="fa fa-check"></i> Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
