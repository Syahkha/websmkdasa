    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">Data Pendaftaran Siswi</div>
            </div>
            <div class="card-body">
                            ...
                            <div class="modal fade" id="l{{$item->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer"><a href="{{url('acc-daftar-si').'/'.$item->ids}}" class="btn btn-outline-primary"><i class="fa fa-check"></i> Terima</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="t{{$item->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"><form action="{{url('ditolak-daftar-si')}}" method="post">@csrf<div class="form-group"><input type="hidden" name="id" value="{{$item->ids}}"><input type="text" class="form-control" required name="ket" placeholder="Masukkan Keterangan Tidak Diterima"></div></div>
        ...
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">Data Pendaftaran Siswi Ditolak</div>
            </div>
            <div class="card-body">
                <pre>
                    <table class="table table-bordered">
